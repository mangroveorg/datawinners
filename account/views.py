...
def settings(request):
    if request.method == 'GET':
        ...
        return render_to_response("account/org_settings.html", {'organization_form': organization_form},
    ...
    if request.method == 'POST':
        ...
        return HttpResponseRedirect('/home') if not organization_form.errors  else render_to_response(
            "account/org_settings.html", {'organization_form': organization_form},
            context_instance=RequestContext(request))
...
def new_user(request):
    if request.method == 'GET':
        ...
        return render_to_response("account/add_user.html", {'profile_form': profile_form},
                                  context_instance=RequestContext(request))
    ...
    if request.method == 'POST':
        ...
        return render_to_response("account/add_user.html", {'profile_form': form},
                                  context_instance=RequestContext(request))
...
def edit_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            ngo_user_profile.save()
            return render_to_response("account/edit_profile.html", {'form': form},
                                      context_instance=RequestContext(request))
