...
DATA_WINNER_LOGIN_PAGE = url("/en/login")
ALL_DATA_PAGE = url("/alldata/")
LOGOUT = url('/logout')
DATA_WINNER_DASHBOARD_PAGE = url("/dashboard")
DATA_WINNER_ALL_PROJECTS_PAGE = url("/alldata/")
DATA_WINNER_REGISTER_PAGE = url("/en/register")
DATA_WINNER_REGISTER_TRIAL_PAGE = url("/en/register/trial/")
