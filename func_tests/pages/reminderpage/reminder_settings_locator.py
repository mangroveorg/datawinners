...
DEADLINE_TYPE_DD = by_css("select#id_deadline_type")
...
BEFORE_DEADLINE_REMINDER_TB = by_css("input#id_reminder_text_before_deadline")

ON_DEADLINE_REMINDER_CB = by_css("input#id_should_send_reminders_on_deadline")
ON_DEADLINE_REMINDER_TB = by_css("input#id_reminder_text_on_deadline")
...
AFTER_DEADLINE_REMINDER_TB = by_css("input#id_reminder_text_after_deadline")

ONLY_DATASENDERS_NOT_SUBMITTED_CB = by_css("input#id_whom_to_send_message")
SAVE_BUTTON = by_css("input[value='Save']")

SUCCESS_MESSAGE_LABEL = by_xpath("//div[@class='success-message-box' and not(contains(@style,'none'))]")