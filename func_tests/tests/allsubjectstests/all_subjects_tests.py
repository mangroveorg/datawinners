...
from tests.allsubjectstests.all_subjects_data import SUBJECT_TYPE, SUBJECT_TYPE_WHITE_SPACES, ERROR_MSG_INVALID_ENTRY, SUBJECT_TYPE_SPL_CHARS, SUBJECT_TYPE_BLANK, ERROR_MSG_BLANK_ENTRY
...
class TestSubjectsPage(unittest.TestCase):
    ...
    def test_add_invalid_subjectType(self):
        ...
        self.validate_error_messages(ERROR_MSG_BLANK_ENTRY)
