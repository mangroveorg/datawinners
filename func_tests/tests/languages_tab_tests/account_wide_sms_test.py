...
class TestAccountWideSMS(HeadlessRunnerTest):
    ...
    def test_warning_and_error_conditions(self):
        ...
        self.assertListEqual([u'Any changes you make will apply for all Data Senders.']*4, [e.text for e in self.driver.find_visible_elements_(by_css(".account_message_warning_message"))])
