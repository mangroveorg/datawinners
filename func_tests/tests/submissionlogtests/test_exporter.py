...
class TestExporter(unittest.TestCase):
    ...
    def test_export(self):
        ...
        self.assertEqual([u'Data Sender', u'Datasender Id', u'Submission Date', u'Phone number', u'Status', u'What is associat\xe9d entity?', u'clinic ID',
                          u"What is your namé?", u"What is age öf father?",u'What is réporting date?',
                          u"What is your blood group?", u"What aré symptoms?",
                          u'What is the GPS code for clinic? Latitude', u'What is the GPS code for clinic? Longitude'], sheet.row_values(0, 0, 14))
        self.assertEqual([u'Rapid weight loss', 2.0], sheet.row_values(1, 11, 13))

        self.assertEqual([u'cid001'], sheet.row_values(1, 6,7))
