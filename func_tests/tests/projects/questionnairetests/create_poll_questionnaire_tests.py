...
class TestCreateBlankPollQuestionnaire(HeadlessRunnerTest):
    ...
    def create_group_with_a_contact(cls):
        ...
        create_questionnaire_options_page = cls.global_navigation.navigate_to_dashboard_page().navigate_to_create_project_page()
    ...
    def test_after_poll_creation_with_group_the_group_should_receive_sms_and_appear_in_sent_sms_table(self):
        ...
        self.poll_Questionnaire_page.select_receipient(GROUP, group_name)
        self.poll_Questionnaire_page.click_create_poll()
        self.driver.wait_for_element(UI_TEST_TIMEOUT, POLL_TAB, True)
