...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reminder.remind_to'
        db.add_column('project_reminder', 'remind_to', self.gf('django.db.models.fields.CharField')(default='all_datasenders', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reminder.remind_to'
        db.delete_column('project_reminder', 'remind_to')
    ...
    models = {
        ...
        'project.reminder': {
            ...
            'remind_to': ('django.db.models.fields.CharField', [], {'default': "'all_datasenders'", 'max_length': '20'}),
