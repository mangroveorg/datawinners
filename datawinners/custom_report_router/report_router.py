...
class ReportRouter(object):
    ...
    def route(self, organization_id, form_submission):
        ...
        custom_report_handler(form_submission.form_code,form_submission.processed_data, form_submission.datarecord_id)

    def has_error_in_submission(self, form_submission):
        return is_not_empty(form_submission.errors)

    def fake_custom_report_handler(self, code, data, record_id):
        pass
