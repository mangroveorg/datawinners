...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatawinnerLog.organization'
        db.add_column('submission_datawinnerlog', 'organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.Organization'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DatawinnerLog.organization'
        db.delete_column('submission_datawinnerlog', 'organization_id')
