...
from datawinners.report.views import AllReportsView, report_content, report_stylesheet, report_font_file, report_filters
...
urlpatterns = patterns('',
                       ...
                       url(r'^reports/(?P<report_id>.+?)/filters/$', report_filters),
