...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BreakBulkSent'
        db.create_table('crs_breakbulksent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q1', self.gf('django.db.models.fields.DateField')(db_column='sent_date')),
            ('q2', self.gf('django.db.models.fields.FloatField')(db_column='weight')),
            ('q3', self.gf('django.db.models.fields.TextField')(db_column='waybill_code')),
            ('q4', self.gf('django.db.models.fields.TextField')(db_column='pl_code')),
        ))
        db.send_create_signal('crs', ['BreakBulkSent'])


    def backwards(self, orm):
        
        # Deleting model 'BreakBulkSent'
        db.delete_table('crs_breakbulksent')
