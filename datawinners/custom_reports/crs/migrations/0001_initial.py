...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crs_sfmdistribution', (
            ...
            ('q2', self.gf('django.db.models.fields.TextField')(db_column='distribution_date')),
            ('q3', self.gf('django.db.models.fields.TextField')(db_column='received_waybill_code')),
            ('q4', self.gf('django.db.models.fields.IntegerField')(db_column='distributed_oil_quantity')),
            ('q5', self.gf('django.db.models.fields.IntegerField')(db_column='distributed_csb_quantity')),
        ...
        db.create_table('crs_physicalinventorysheet', (
            ...
            ('q2', self.gf('django.db.models.fields.TextField')(db_column='physical_inventory_closing_date')),
            ('q3', self.gf('django.db.models.fields.TextField')(db_column='actual_physical_inventory_date')),
            ...
            ('q6', self.gf('django.db.models.fields.IntegerField')(db_column='good_net_weight')),
            ('q7', self.gf('django.db.models.fields.IntegerField')(db_column='damaged_net_weight')),
        ))
    ...
    models = {
        'crs.physicalinventorysheet': {
            ...
            'q2': ('django.db.models.fields.TextField', [], {'db_column': "'physical_inventory_closing_date'"}),
            'q3': ('django.db.models.fields.TextField', [], {'db_column': "'actual_physical_inventory_date'"}),
        ...
        'crs.sfmdistribution': {
            ...
            'q2': ('django.db.models.fields.TextField', [], {'db_column': "'distribution_date'"}),
