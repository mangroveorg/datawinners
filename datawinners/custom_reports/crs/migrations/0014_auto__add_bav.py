...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BAV'
        db.create_table('crs_bav', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q1', self.gf('django.db.models.fields.TextField')(db_column='bav_type')),
            ('q2', self.gf('django.db.models.fields.DateField')(db_column='bav_date')),
            ('q3', self.gf('django.db.models.fields.IntegerField')(db_column='no_of_recipients')),
            ('q4', self.gf('django.db.models.fields.FloatField')(null=True, db_column='rice')),
            ('q5', self.gf('django.db.models.fields.FloatField')(null=True, db_column='oil')),
            ('q6', self.gf('django.db.models.fields.FloatField')(null=True, db_column='csb')),
            ('q7', self.gf('django.db.models.fields.FloatField')(null=True, db_column='sorghum')),
        ))
        db.send_create_signal('crs', ['BAV'])


    def backwards(self, orm):
        
        # Deleting model 'BAV'
        db.delete_table('crs_bav')
