...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillOfLading.q9'
        db.add_column('crs_billoflading', 'q9', self.gf('django.db.models.fields.FloatField')(default=0, db_column='freight'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillOfLading.q9'
        db.delete_column('crs_billoflading', 'freight')
