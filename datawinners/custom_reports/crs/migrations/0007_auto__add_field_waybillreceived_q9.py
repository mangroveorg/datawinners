...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WayBillReceived.q9'
        db.add_column('crs_waybillreceived', 'q9', self.gf('django.db.models.fields.TextField')(null=True, db_column='transaction_type'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WayBillReceived.q9'
        db.delete_column('crs_waybillreceived', 'transaction_type')
