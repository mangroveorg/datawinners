...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crs_packinglist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data_record_id', self.gf('django.db.models.fields.TextField')()),
            ('q1', self.gf('django.db.models.fields.TextField')(db_column='pl_code')),
            ('q2', self.gf('django.db.models.fields.FloatField')(db_column='rice_cost')),
            ('q3', self.gf('django.db.models.fields.FloatField')(db_column='oil_cost')),
            ('q4', self.gf('django.db.models.fields.FloatField')(db_column='csb_cost')),
            ('q5', self.gf('django.db.models.fields.FloatField')(db_column='sorghum_cost')),
        ))
        db.send_create_signal('crs', ['PackingList'])


    def backwards(self, orm):
        
        # Deleting model 'PackingList'
        db.delete_table('crs_packinglist')
