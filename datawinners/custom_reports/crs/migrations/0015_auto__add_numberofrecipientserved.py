...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crs_numberofrecipientserved', (
            ...
            ('q1', self.gf('django.db.models.fields.TextField')(db_column='received_type')),
            ('q2', self.gf('django.db.models.fields.DateField')(db_column='received_date')),
            ('q3', self.gf('django.db.models.fields.IntegerField')(db_column='no_of_type1_recipient')),
            ('q4', self.gf('django.db.models.fields.IntegerField')(db_column='no_of_type2_recipient')),
            ('q5', self.gf('django.db.models.fields.IntegerField')(db_column='no_of_new_type1_recipient')),
            ('q6', self.gf('django.db.models.fields.IntegerField')(db_column='no_of_new_type2_recipient')),
        ))
        db.send_create_signal('crs', ['NumberOfRecipientServed'])


    def backwards(self, orm):
        
        # Deleting model 'NumberOfRecipientServed'
        db.delete_table('crs_numberofrecipientserved')
