...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContainerSent'
        db.create_table('crs_containersent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q1', self.gf('django.db.models.fields.TextField')(db_column='bill_of_lading')),
            ('q2', self.gf('django.db.models.fields.FloatField')(db_column='weight')),
            ('q3', self.gf('django.db.models.fields.TextField')(db_column='container_code')),
        ))
        db.send_create_signal('crs', ['ContainerSent'])


    def backwards(self, orm):
        
        # Deleting model 'ContainerSent'
        db.delete_table('crs_containersent')
