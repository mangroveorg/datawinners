...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Distribution.distribution_type'
        db.add_column('crs_distribution', 'distribution_type', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Distribution.distribution_type'
        db.delete_column('crs_distribution', 'distribution_type')
