...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Distribution.q10'
        db.delete_column('crs_distribution', 'returned_csb')

        # Deleting field 'Distribution.q12'
        db.delete_column('crs_distribution', 'returned_rice')

        # Deleting field 'Distribution.q9'
        db.delete_column('crs_distribution', 'returned_oil')

        # Deleting field 'Distribution.q11'
        db.delete_column('crs_distribution', 'returned_sorghum')


    def backwards(self, orm):
        
        # Adding field 'Distribution.q10'
        db.add_column('crs_distribution', 'q10', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='returned_csb'), keep_default=False)

        # Adding field 'Distribution.q12'
        db.add_column('crs_distribution', 'q12', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='returned_rice'), keep_default=False)

        # Adding field 'Distribution.q9'
        db.add_column('crs_distribution', 'q9', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='returned_oil'), keep_default=False)

        # Adding field 'Distribution.q11'
        db.add_column('crs_distribution', 'q11', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='returned_sorghum'), keep_default=False)
