...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BreakBulkSent.q5'
        db.add_column('crs_breakbulksent', 'q5', self.gf('django.db.models.fields.TextField')(default='', db_column='food_type'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BreakBulkSent.q5'
        db.delete_column('crs_breakbulksent', 'food_type')
