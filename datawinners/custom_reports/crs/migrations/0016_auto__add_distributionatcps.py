...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DistributionAtCPS'
        db.create_table('crs_distributionatcps', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q1', self.gf('django.db.models.fields.TextField')(db_column='centre_code')),
            ('q2', self.gf('django.db.models.fields.DateField')(db_column='received_date')),
            ('q3', self.gf('django.db.models.fields.TextField')(db_column='pl_code')),
            ('q4', self.gf('django.db.models.fields.FloatField')(db_column='rice')),
            ('q5', self.gf('django.db.models.fields.FloatField')(db_column='oil')),
            ('q6', self.gf('django.db.models.fields.FloatField')(db_column='csb')),
        ))
        db.send_create_signal('crs', ['DistributionAtCPS'])


    def backwards(self, orm):
        
        # Deleting model 'DistributionAtCPS'
        db.delete_table('crs_distributionatcps')
