...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillOfLading.q7'
        db.add_column('crs_billoflading', 'q7', self.gf('django.db.models.fields.FloatField')(default=0, db_column='net_weight'), keep_default=False)

        # Adding field 'BillOfLading.q8'
        db.add_column('crs_billoflading', 'q8', self.gf('django.db.models.fields.TextField')(default='', db_column='ccc_number'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillOfLading.q7'
        db.delete_column('crs_billoflading', 'net_weight')

        # Deleting field 'BillOfLading.q8'
        db.delete_column('crs_billoflading', 'ccc_number')
