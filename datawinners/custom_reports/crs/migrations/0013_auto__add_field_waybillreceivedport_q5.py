...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WayBillReceivedPort.q5'
        db.add_column('crs_waybillreceivedport', 'q5', self.gf('django.db.models.fields.TextField')(null=True, db_column='container_code'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WayBillReceivedPort.q5'
        db.delete_column('crs_waybillreceivedport', 'container_code')
