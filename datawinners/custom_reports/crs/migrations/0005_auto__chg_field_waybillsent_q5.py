...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'WayBillSent.q5' to match new field type.
        db.rename_column('crs_waybillsent', 'site_code', 'warehouse_code')
        # Changing field 'WayBillSent.q5'
        db.alter_column('crs_waybillsent', 'warehouse_code', self.gf('django.db.models.fields.TextField')(null=True, db_column='warehouse_code'))


    def backwards(self, orm):
        
        # Renaming column for 'WayBillSent.q5' to match new field type.
        db.rename_column('crs_waybillsent', 'warehouse_code', 'site_code')
        # Changing field 'WayBillSent.q5'
        db.alter_column('crs_waybillsent', 'site_code', self.gf('django.db.models.fields.TextField')(null=True, db_column='site_code'))
