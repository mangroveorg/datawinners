...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'WayBillReceivedPort.q6' to match new field type.
        db.rename_column('crs_waybillreceivedport', 'warehouse_code', 'receiver_code')
        # Changing field 'WayBillReceivedPort.q6'
        db.alter_column('crs_waybillreceivedport', 'receiver_code', self.gf('django.db.models.fields.TextField')(db_column='receiver_code'))


    def backwards(self, orm):
        
        # Renaming column for 'WayBillReceivedPort.q6' to match new field type.
        db.rename_column('crs_waybillreceivedport', 'receiver_code', 'warehouse_code')
        # Changing field 'WayBillReceivedPort.q6'
        db.alter_column('crs_waybillreceivedport', 'warehouse_code', self.gf('django.db.models.fields.TextField')(db_column='warehouse_code'))
    ...
    models = {
        ...
        'crs.waybillreceivedport': {
            ...
            'q6': ('django.db.models.fields.TextField', [], {'db_column': "'receiver_code'"})
        },
        'crs.waybillsent': {
