...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crs_billoflading', (
            ...
            ('q2', self.gf('django.db.models.fields.TextField')(db_column='shipment_type')),
            ('q3', self.gf('django.db.models.fields.DateField')(db_column='issue_date')),
            ('q4', self.gf('django.db.models.fields.TextField')(db_column='food_type')),
            ('q5', self.gf('django.db.models.fields.TextField')(db_column='bill_of_lading_code')),
            ('q6', self.gf('django.db.models.fields.FloatField')(db_column='weight')),
        ))
        db.send_create_signal('crs', ['BillOfLading'])


    def backwards(self, orm):
        
        # Deleting model 'BillOfLading'
        db.delete_table('crs_billoflading')
