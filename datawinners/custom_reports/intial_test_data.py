...
def create_waybill_sent_received_project(PACKAGING_LIST_ENTITY_TYPE, manager):
    ...
    question1 = TextField(label="Which packaging list are you reporting on??", code="EID",
    ...
    question2 = TextField(label="What is the waybill code?", code="WC", name="What is the waybill code?",
    ...
    question3 = DateField(label="Date of sending?", code="DS", name="Date of sending?",
        date_format="dd.mm.yyyy", ddtype=date_type,
        instruction="Answer must be a date in the following format: day.month.year. Example: 25.12.2011",
        event_time_field_flag=True)
    question4 = TextField(label="What is the Type of transaction?", code="TT", name="What is the Type of transaction?",
        constraints=[TextLengthConstraint(min=1, max=10)],
        defaultValue="some default value", language="en", ddtype=name_type,
        instruction="Answer must be a word or phrase 10 characters maximum")
    question5 = TextField(label="What is the Warehouse Code?", code="WH", name="What is the Warehouse Code?",
        constraints=[TextLengthConstraint(min=1, max=10)],
        defaultValue="some default value", language="en", ddtype=name_type,
        instruction="Answer must be a word or phrase 10 characters maximum")
    question6 = TextField(label="Name of Sender?", code="NS", name="Name of Sender?",
        constraints=[TextLengthConstraint(min=1, max=10)],
        defaultValue="some default value", language="en", ddtype=name_type,
        instruction="Answer must be a word or phrase 10 characters maximum")
    question7 = TextField(label="What is the Truck Id?", code="TID", name="What is the Truck Id?",
        constraints=[TextLengthConstraint(min=1, max=10)],
        defaultValue="some default value", language="en", ddtype=name_type,
        instruction="Answer must be a word or phrase 10 characters maximum")
    question8 = TextField(label="What is the Food Type?", code="FT", name="What is the Food Type?",
        constraints=[TextLengthConstraint(min=1, max=10)],
        defaultValue="some default value", language="en", ddtype=name_type,
        instruction="Answer must be a word or phrase 10 characters maximum")
    question9 = IntegerField(label="What is the Net Weight?", code="NW", name="What is the Net Weight?",
        constraints=[NumericRangeConstraint(min=18, max=100)], ddtype=weight_type,
