...
from datawinners.dashboard.views import dashboard, get_submission_breakup, get_submissions_about_project, geo_json_for_entity, render_map
...
urlpatterns = patterns('',
    ...
    (r'^get_geojson/(?P<entity_type>.+?)$', geo_json_for_entity),
