describe("dwtable test", function() {
    ...
    var response_10_datarows = {responseText: {"iTotalRecords": 18, "data": [["Clinic", "TSIMANARIRAZANA", "TSIMANARIRAZANA,ANDRAINJATO AVARATRA,FIANARANTSOA I,HAUTE MATSIATRA,Madagascar", "-12.35, 49.3", "87654325", "cli12"], ["Clinic", "Antalaha", "ANTALAHA,SAVA,Madagascar", "-14.8833, 50.25", "87654323", "cli10"], ["Clinic", "ANALAMANGA", "ANALAMANGA,Madagascar", "-18.8, 47.4833", "87654324", "cli11"], ["Kochi Clinic", "Test", "India,Kerala,Kochi", "9.939248, 76.259625", "123460", "cid005"], ["New Gwalior Clinic", "Test", "India,Madhya Pradesh,New Gwalior", "26.227112, 78.18708", "1234561", "cid006"], ["Indore Clinic", "Test", "India,Madhya Pradesh,Indore", "22.7167, 75.8", "1234562", "cid007"], ["Khandwa Clinic", "Test", "India,MP,Khandwa", "21.8333, 76.3667", "123459", "cid004"], ["Jabalpur Clinic", "Test", "India,MP,Jabalpur", "23.2, 79.95", "123458", "cid003"], ["Satna Clinic", "Test", "India,MP,Satna", "24.5667, 80.8333", "123457", "cid002"], ["Clinic", "Antsirabe", "ANTSIRABE,AMBANJA,DIANA,Madagascar", "-19.8167, 47.0667", "87654326", "cli13"]], "iTotalDisplayRecords": 18, "iDisplayStart": 0, "iDisplayLength": 10}};
    var respose_25_datarows = {responseText: {"iTotalRecords": 25, "data": [["Clinic", "TSIMANARIRAZANA", "TSIMANARIRAZANA,ANDRAINJATO AVARATRA,FIANARANTSOA I,HAUTE MATSIATRA,Madagascar", "-12.35, 49.3", "87654325", "cli12"], ["Clinic", "Antalaha", "ANTALAHA,SAVA,Madagascar", "-14.8833, 50.25", "87654323", "cli10"], ["Clinic", "ANALAMANGA", "ANALAMANGA,Madagascar", "-18.8, 47.4833", "87654324", "cli11"], ["Kochi Clinic", "Test", "India,Kerala,Kochi", "9.939248, 76.259625", "123460", "cid005"], ["New Gwalior Clinic", "Test", "India,Madhya Pradesh,New Gwalior", "26.227112, 78.18708", "1234561", "cid006"], ["Indore Clinic", "Test", "India,Madhya Pradesh,Indore", "22.7167, 75.8", "1234562", "cid007"], ["Khandwa Clinic", "Test", "India,MP,Khandwa", "21.8333, 76.3667", "123459", "cid004"], ["Jabalpur Clinic", "Test", "India,MP,Jabalpur", "23.2, 79.95", "123458", "cid003"], ["Satna Clinic", "Test", "India,MP,Satna", "24.5667, 80.8333", "123457", "cid002"], ["Clinic", "Antsirabe", "ANTSIRABE,AMBANJA,DIANA,Madagascar", "-19.8167, 47.0667", "87654326", "cli13"], ["Clinic", "Besalampy", "BESALAMPY,MELAKY,Madagascar", "-16.75, 44.5", "87654327", "cli14"], ["Clinic", "Analalava", "ANALALAVA,SOFIA,Madagascar", "-14.6333, 47.7667", "987654321", "cli8"], ["Clinic", "Farafangana", "FARAFANGANA,ATSIMO ATSINANANA,Madagascar", "-22.8, 47.8333", "87654328", "cli15"], ["Clinic", "Mahajanga", "MAHAJANGA,MAHAJANGA I,BOENY,Madagascar", "-15.6667, 46.35", "87654331", "cli18"], ["Clinic", "Andapa", "ANDAPA,SAVA,Madagascar", "-14.65, 49.6167", "87654322", "cli9"], ["Clinic", "Fianarantsoa-I", "Fianarantsoa-I", "-21.45, 47.1", "87654329", "cli16"], ["Clinic", "Sainte-Marie", "Sainte-Marie", "-17.0833, 49.8167", "87654330", "cli17"], ["Bhopal Clinic", "Test", "India,MP,Bhopal", "23.2833, 77.35", "123456", "cid001"], ["Clinic", "TSIMANARIRAZANA", "TSIMANARIRAZANA,ANDRAINJATO AVARATRA,FIANARANTSOA I,HAUTE MATSIATRA,Madagascar", "-12.35, 49.3", "87654325", "cli12"], ["Clinic", "Antalaha", "ANTALAHA,SAVA,Madagascar", "-14.8833, 50.25", "87654323", "cli10"], ["Clinic", "ANALAMANGA", "ANALAMANGA,Madagascar", "-18.8, 47.4833", "87654324", "cli11"], ["Kochi Clinic", "Test", "India,Kerala,Kochi", "9.939248, 76.259625", "123460", "cid005"], ["New Gwalior Clinic", "Test", "India,Madhya Pradesh,New Gwalior", "26.227112, 78.18708", "1234561", "cid006"], ["Indore Clinic", "Test", "India,Madhya Pradesh,Indore", "22.7167, 75.8", "1234562", "cid007"], ["Khandwa Clinic", "Test", "India,MP,Khandwa", "21.8333, 76.3667", "123459", "cid004"]], "iTotalDisplayRecords": 25, "iDisplayStart": 0, "iDisplayLength": 25}}
    ...
    it('should find Select all link when all rows in the page are selected', function() {
        ...
        expect(table.find('.table_wrapper .select_all_message').text()).toEqual("You have selected 10 Subject(s) on this page. Select all  18 Subject(s)")
    });

    it('should find Clear all link when Select all is clicked and finds it disappear when Clear Selection is clicked',function(){
        var table = $("#simpleTable_wrapper");
        select_all_rows(table);
        table.find('.select_all_message a').click();
        expect(table.find('.select_all_message').text()).toEqual('You have selected all 18 Subject(s). Clear Selection');
    ...
    it('should verify number of table rows and pagination text when page size is changed', function(){
        ...
        var pagesize = 25;
        change_page_size_to(pagesize);
        expect(table.find('.row_checkbox')).toHaveLength(25);
        expect(table.find('.dataTables_info').first()).toHaveText('1 to 25 of 25 Subject(s)');
    ...
    it('should go to next page when paginate-next button is clicked', function() {
        ...
        var params = $.ajax.mostRecentCall.args[0];
        var nextPageStartNumber = ajaxRequestDataValue(params.data, 'iDisplayStart');
        expect(nextPageStartNumber).toEqual(10);
    });

    function verifyInitialState(table) {
        expect(table.find('.dataTables_info').first()).toHaveText('1 to 10 of 18 Subject(s)');
    ...
    function setupSpyForTableData() {
        spyOn(jQuery, "ajax").andCallFake(function(params) {
            var pageLength = ajaxRequestDataValue(params.data, 'iDisplayLength');
            var nextPageStartNumber = ajaxRequestDataValue(params.data, 'iDisplayStart');
            if (pageLength == 25)
                params.success(respose_25_datarows.responseText);
            else
                params.success(response_10_datarows.responseText);
        });
    }
});