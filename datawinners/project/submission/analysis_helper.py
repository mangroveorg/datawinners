        ...
        if linked_id_fields:
            for linked_id_field in linked_id_fields:
                if linked_id_field.unique_id_type in parent_field_types:
                    continue
                linked_id_info = {'code': field.code, 'type': field.unique_id_type,
                                  'parent_code': field.parent_field_code, 'linked_code': linked_id_field.code,
                                  'linked_type': linked_id_field.unique_id_type,
                                  'children': _get_linked_id_details(dbm, linked_id_field,
    ...
    try:
        ...
        for linked_id_info in linked_id_detail:
            if nested:
                ...
                code = linked_id_info['parent_code'] + '-' + linked_id_info['code'] if linked_id_info[
