...
urlpatterns = patterns('',
    ...
    url(r'^project/register_subjects/(?P<project_id>\w+?)/$', subject_web_questionnaire, name="subject_questionnaire"),
    url(r'^project/testquestionnaire/(?P<project_id>\w+?)/$', survey_web_questionnaire, name="web_questionnaire"),
...
#    (r'^project/datarecords/filter$', submissions),
    ...
    url(r'^project/(?P<project_id>.+?)/results/(?P<questionnaire_code>.+?)/tab/(?P<tab>[\d]?)/$', submission_views.index, name='submissions'),
    ...
    url(r'^project/(?P<project_id>.+?)/submissions/edit/(?P<survey_response_id>[^\\/]+?)/tab/(?P<tab>[\d]?)/$', submission_views.edit, name="submissions_edit"),
    url(r'^project/(?P<project_id>.+?)/submissions/delete/$', submission_views.delete, name="submissions_delete"),
