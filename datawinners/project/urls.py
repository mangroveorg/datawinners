...
urlpatterns = patterns('',
                       ...
                       url(r'^project/poll/(?P<project_id>\w+?)/$', get_poll_info, name="poll"),
                       ...
                       url(r'^project/(?P<project_id>.+?)/data/(?P<questionnaire_code>[^\\/]+?)/$',
                           submission_views.analysis, name="submission_analysis"),
                       ...
                       url(r'^project/(?P<project_id>.+?)/predict/(?P<questionnaire_code>[^\\/]+?)/$',
                           submission_views.predict, name="predict"),
                       ...
                       url(r'^project/get_poll_sent_messages/(?P<project_id>\w+?)/$',  get_poll_sent_messages, name="get_poll_sent_messages"),
