...
urlpatterns = patterns('',
    ...
    url(r'^project/register_datasenders/(?P<project_id>\w+?)/$', create_data_sender_and_web_user,name='create_data_sender_and_web_user'),
    ...
    url(r'^project/(?P<project_id>.+?)/someresult/(?P<questionnaire_code>.+?)/submission/(?P<submission_id>.+?)$', edit_submission, name="edit_submission"),
