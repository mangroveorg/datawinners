...
from datawinners.entity.views import disassociate_datasenders
...
urlpatterns = patterns('',
                       ...
                       url(r'^project/edit_subjects/(?P<project_id>.+?)/$', edit_subject_questionaire,
                           name="edit_subject_questionaire"),
                       ...
                       url(r'^project/(?P<project_id>.+?)/submissions/edit/(?P<survey_response_id>[^\\/]+?)/tab/(?P<tab>[\d]?)/$',
                           submission_views.edit, name="submissions_edit"),
