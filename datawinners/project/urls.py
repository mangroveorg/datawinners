...
from datawinners.project.views import preferences_views
...
urlpatterns = patterns('',
                       ...
                       (r'^project/hide_submission_log_column/$', preferences_views.hide_submission_log_column),
                       (r'^project/get_hidden_columns/$', preferences_views.get_hidden_columns),
