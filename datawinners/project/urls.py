...
urlpatterns = patterns('',
                       ...
                       url(r'^project/register_subjects/(?P<project_id>\w+?)/entity/(?P<entity_type>\w+?)/$', subject_web_questionnaire,
                       ...
                       url(r'^project/preview/subject_registration_form/preview/(?P<project_id>\w+?)/entity/(?P<entity_type>\w+?)/$',
