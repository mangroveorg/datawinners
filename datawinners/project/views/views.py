    ...
    def success_response(self, is_update, organization, questionnaire_form):
        ...
        try:
            ...
            if response.success:
                ...
                update_submission_search_for_subject_edition(self.manager, self.form_model.entity_type, response.processed_data['q6'], response.processed_data['q2'], response.processed_data)
