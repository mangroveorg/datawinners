...
from datawinners.accountmanagement.decorators import is_not_expired, session_not_expired, is_datasender, restrict_access
...
def parse_successful_imports(successful_imports):
    ...
    for successful_import in successful_imports.values():
        ...
        data_sender['coordinates'] = ','.join(
            str(coordinate) for coordinate in successful_import["g"]) if successful_import.get('g') else ""
