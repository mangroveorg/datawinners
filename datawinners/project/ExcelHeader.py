...
#     def _prefix(self):
#         return [self._id(), self._subject_name_header(), self._subject_id_header(), self._reporting_period_header(),
#                 self._submission_date_header(), self._data_sender_name_header(), self._data_sender_id_header()]
#
