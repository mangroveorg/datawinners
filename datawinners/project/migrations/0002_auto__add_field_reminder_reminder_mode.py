...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reminder.reminder_mode'
        db.add_column('project_reminder', 'reminder_mode', self.gf('django.db.models.fields.CharField')(default='before_deadline', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reminder.reminder_mode'
        db.delete_column('project_reminder', 'reminder_mode')
