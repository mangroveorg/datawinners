...
class TestProjectModel(unittest.TestCase):
    ...
    def test_should_return_data_senders_without_submissions_for_month(self):
        reminder_and_deadline_for_month = {
            "reminders_enabled": "True",
            "deadline_month": "5",
            "deadline_type": "current",
        ...
        with patch("mangrove.form_model.project.get_reporters_who_submitted_data_for_frequency_period") as get_reporters_who_submitted_data_for_frequency_period_mock:
            with patch("mangrove.form_model.project.load_data_senders") as load_data_senders_mock:
                ...
                data_senders = questionnaire.get_data_senders_without_submissions_for(date(2011, 11, 8), dbm, "month")

                get_reporters_who_submitted_data_for_frequency_period_mock.assert_called_with(dbm, questionnaire.id, date(2011,11,1), date(2011,11,15))
    ...
    def test_should_return_data_senders_without_submissions_for_week(self):
        ...
        with patch("mangrove.form_model.project.get_reporters_who_submitted_data_for_frequency_period") as get_reporters_who_submitted_data_for_frequency_period_mock:
            with patch("mangrove.form_model.project.load_data_senders") as load_data_senders_mock:
                ...
                data_senders = questionnaire.get_data_senders_without_submissions_for(date(2011, 11, 8), dbm, "week")

                get_reporters_who_submitted_data_for_frequency_period_mock.assert_called_with(dbm, questionnaire.id, date(2011,11,5), date(2011,11,11))
