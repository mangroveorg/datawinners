...
from project.questionnaire_fields import SubjectField, FormField

class TestSubjectField(unittest.TestCase):
    def test_create_entity_list_for_reporters(self):
        with patch ("project.questionnaire_fields.SubjectField._data_sender_choice_fields") as ds_choice_fields:
            ...
            subject_field = SubjectField(Mock(spec = DatabaseManager), project)
    ...
    def test_create_entity_list_for_subjects(self):
        with patch ("project.questionnaire_fields.SubjectField._subject_choice_fields") as subject_choice_fields:
