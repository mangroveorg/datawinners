...
var initPaginationWidget = function(report_id) {
    ...
    $("#report_container>.pagination_container").append('<div id="pagination-' + report_id + '"></div>');
    new PaginationWidget('#pagination-' + report_id, loadData, loadData, pageSize, currentPageCount, totalCount);
};
...
var loadReportTabCallback = function(anchorElement, response) {
    ...
    initPaginationWidget(anchorElement.attr("id"));
};
