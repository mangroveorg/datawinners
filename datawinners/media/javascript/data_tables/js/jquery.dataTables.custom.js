/* Erdong: this file has been modified to support showing table information in specified element rather than generate by DataTable */
/*
...
(function($, window, document) {
    ...
    $.fn.dataTable = function (oInit) {
                ...
                if (cOption == '<') {
                    ...
                    if (cNext == "'" || cNext == '"') {
                        ...
                        if (sAttr.indexOf('.') != -1) {
                            ...
                            nTmp = jQuery("#" + sAttr.substr(1, sAttr.length - 1))
                            nTmp.data('is_specified', true)
                        }
                        else {
                    ...
                    /* Filter */
                    nTmp = _fnFeatureHtmlFilter(oSettings, nTmp);
                    iPushFeature = 1;
                }
         ...
         * Returns:  node
         * Inputs:   object:oSettings - dataTables settings object, node:nFilter - filter input node
         */
        function _fnFeatureHtmlFilter(oSettings, nFilter) {
            var nFilter = nFilter || document.createElement('div');
            if (oSettings.sTableId !== '' && typeof oSettings.aanFeatures.f == "undefined" && !nFilter.data) {
         ...
         * Inputs:   node:nTable - table we are using as a
         *
         */
