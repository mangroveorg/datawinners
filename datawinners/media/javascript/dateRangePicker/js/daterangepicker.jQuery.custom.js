...
jQuery.fn.daterangepicker = function(settings){
    ...
    function hideRPForAllPeriods(rp){
		if(rp.data('state') == 'open'){
			rp.data('state', 'closed');
			rp.fadeOut(300);
			options.onClose();
    ...
    function updateMonthPickerDates(range_list_item) {
        var rp = getRPFromRPListItem(range_list_item);
    ...
    function getRPFromRPListItem(range_list_item) {
        return range_list_item.parents('.ui-daterangepicker');
    }
    ...
    function onAllPeriodSelected(range_list_item) {
        ...
        $('#'+ rp.data('for')).val(range_list_item.text());
	...
	jQuery.fn.clickActions = function(rp, rpPickers, doneBtn){
        ...
        if(range_list_item.is('.ui-daterangepicker-specificDate')){
            ...
            updateMonthPickerDates(range_list_item);
        }

		return false;
	}

    var rpPickers = function buildRPicker() {
