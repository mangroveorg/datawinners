    ...
    self.activate_poll = function() {
        ...
        $.post(activate_poll_url, data).done(function (response) {
            ...
            if (responseJson['success']) {
                ...
                var responseMessage =responseJson['message'].replace(responseJson['question_name_active'], '<a class="link_color" href="/project/poll/' + responseJson['question_id_active'] + '">' + responseJson['question_name_active'].toUpperCase() + '</a>');
