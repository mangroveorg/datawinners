...
$("#reminders").accordion({   alwaysOpen: false, collapsible: true,autoHeight:false});
$("#subjects").accordion({   alwaysOpen: false, collapsible: true,autoHeight:false, active: false});
...
$("#reminders").accordion({   alwaysOpen: false, active: false,collapsible: true,autoHeight:false});
