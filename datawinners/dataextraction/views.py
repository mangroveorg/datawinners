...
from dataextraction.helper import  encapsulate_data_for_subject, convert_to_json_response, encapsulate_data_for_form, convert_to_json_file_download_response, generate_filename
...
def get_for_subject(request, subject_type, subject_id, start_date=None, end_date=None):
    if request.method == 'GET':
        ...
        return convert_to_json_file_download_response(data_for_subject, generate_filename('%s_%s' %(subject_type,subject_id), start_date, end_date))
