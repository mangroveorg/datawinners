...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OutgoingNumberSetting'
        db.create_table('accountmanagement_outgoingnumbersetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('smsc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.SMSC'], null=True)),
        ))
        db.send_create_signal('accountmanagement', ['OutgoingNumberSetting'])

        # Adding field 'OrganizationSetting.outgoing_number'
        db.add_column('accountmanagement_organizationsetting', 'outgoing_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.OutgoingNumberSetting'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OutgoingNumberSetting'
        db.delete_table('accountmanagement_outgoingnumbersetting')

        # Deleting field 'OrganizationSetting.outgoing_number'
        db.delete_column('accountmanagement_organizationsetting', 'outgoing_number_id')
