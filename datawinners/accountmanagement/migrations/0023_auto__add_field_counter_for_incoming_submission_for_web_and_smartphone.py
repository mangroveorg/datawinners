...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTracker.incoming_web_count'
        db.add_column('accountmanagement_messagetracker', 'incoming_web_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MessageTracker.incoming_sp_count'
        db.add_column('accountmanagement_messagetracker', 'incoming_sp_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTracker.incoming_web_count'
        db.delete_column('accountmanagement_messagetracker', 'incoming_web_count')

        # Deleting field 'MessageTracker.incoming_sp_count'
        db.delete_column('accountmanagement_messagetracker', 'incoming_sp_count')
