...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accountmanagement_organization', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
        db.add_column('accountmanagement_organization', 'status_changed_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=False, blank=True, null=True))


    def backwards(self, orm):

        # Deleting field 'Organization.status'
        db.delete_column('accountmanagement_organization', 'status')
        db.delete_column('accountmanagement_organization', 'status_changed_datetime')
    ...
    models = {
        ...
        'accountmanagement.organizationsetting': {
            ...
            'outgoing_number': ('django.db.models.fields.related.ForeignKey', [],
                                    {'to': "orm['accountmanagement.OutgoingNumberSetting']", 'null': 'True'}),
        ...
        'accountmanagement.outgoingnumbersetting': {
            ...
            'smsc': (
                'django.db.models.fields.related.ForeignKey', [],
                    {'to': "orm['accountmanagement.SMSC']", 'null': 'True'})
        },
