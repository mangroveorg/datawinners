...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTracker.outgoing_sms_charged_count'
        db.add_column('accountmanagement_messagetracker', 'outgoing_sms_charged_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MessageTracker.sent_reminders_charged_count'
        db.add_column('accountmanagement_messagetracker', 'sent_reminders_charged_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MessageTracker.sms_api_usage_charged_count'
        db.add_column('accountmanagement_messagetracker', 'sms_api_usage_charged_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTracker.outgoing_sms_charged_count'
        db.delete_column('accountmanagement_messagetracker', 'outgoing_sms_charged_count')

        # Deleting field 'MessageTracker.sent_reminders_charged_count'
        db.delete_column('accountmanagement_messagetracker', 'sent_reminders_charged_count')

        # Deleting field 'MessageTracker.sms_api_usage_charged_count'
        db.delete_column('accountmanagement_messagetracker', 'sms_api_usage_charged_count')
