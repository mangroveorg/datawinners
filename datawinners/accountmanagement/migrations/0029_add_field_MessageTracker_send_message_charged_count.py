...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTracker.send_message_charged_count'
        db.add_column('accountmanagement_messagetracker', 'send_message_charged_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTracker.send_message_charged_count'
        db.delete_column('accountmanagement_messagetracker', 'send_message_charged_count')
