...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTracker.send_message_count'
        db.add_column('accountmanagement_messagetracker', 'send_message_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MessageTracker.sent_reminders_count'
        db.add_column('accountmanagement_messagetracker', 'sent_reminders_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTracker.send_message_count'
        db.delete_column('accountmanagement_messagetracker', 'send_message_count')

        # Deleting field 'MessageTracker.sent_reminders_count'
        db.delete_column('accountmanagement_messagetracker', 'sent_reminders_count')
