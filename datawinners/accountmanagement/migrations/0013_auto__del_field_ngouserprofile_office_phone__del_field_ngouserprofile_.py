...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accountmanagement_ngouserprofile', 'office_phone')

        # Deleting field 'NGOUserProfile.skype'
        db.delete_column('accountmanagement_ngouserprofile', 'skype')


    def backwards(self, orm):
        
        # Adding field 'NGOUserProfile.office_phone'
        db.add_column('accountmanagement_ngouserprofile', 'office_phone', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'NGOUserProfile.skype'
        db.add_column('accountmanagement_ngouserprofile', 'skype', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
