...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageTracker.sms_api_usage_count'
        db.add_column('accountmanagement_messagetracker', 'sms_api_usage_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageTracker.sms_api_usage_count'
        db.delete_column('accountmanagement_messagetracker', 'sms_api_usage_count')
