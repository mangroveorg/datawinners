...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrganizationSetting.smsc'
        db.delete_column('accountmanagement_organizationsetting', 'smsc_id')


    def backwards(self, orm):
        
        # Adding field 'OrganizationSetting.smsc'
        db.add_column('accountmanagement_organizationsetting', 'smsc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.SMSC'], null=True, blank=True), keep_default=False)
        db.commit_transaction()
        db.start_transaction()
        for org in orm.OrganizationSetting.objects.all():
            if not is_empty(org.outgoing_number):
                org.smsc =  org.outgoing_number.smsc
                org.save()
    ...
    models = {
        ...
        'accountmanagement.outgoingnumbersetting': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
