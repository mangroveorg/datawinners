...
class TestViews(TestCase):
    ...
    def test_should_create_new_user_as_extended_user(self, manager_def_mock, user_mock, ngouserprofile_def_mock,
        ...
        manager_mock, user_saved_mock, ngo_user_profile_mock, questionnaire_mock, user_profile_form_mock = self._base_dependency_setup(
            manager_def_mock, user_mock, ngouserprofile_def_mock, project_mock, user_profile_form_def_mock)
    ...
    def _base_dependency_setup(self, manager_def_mock, user_mock, ngouserprofile_def_mock, project_mock,
        ...
        user_profile_form_mock = MagicMock(spec=UserProfileForm)
        user_profile_form_mock.is_valid.return_value = True
        user_profile_form_mock.errors = {}
        user_profile_form_def_mock.return_value = user_profile_form_mock

        return manager_mock, user_saved_mock, ngo_user_profile_mock, questionnaire_mock, user_profile_form_mock
