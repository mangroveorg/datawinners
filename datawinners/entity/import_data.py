...
def translate_errors(items, question_dict={}, question_answer_dict={}):
    ...
    for key, value in items:
        ...
        if 'is required' in value:
            ...
            errors.append(_("Answer %s for question %s is longer than allowed.") % ((answer).rstrip(".0"), question_label))
            ...
            errors.append(_("Answer %s for question %s is shorter than allowed.") % ((answer).rstrip(".0"), question_label))

        elif 'Sorry, the telephone number' in value:
            errors.append(_("Sorry, the telephone number %s has already been registered.") % (answer).rstrip(".0"))
