...
from datawinners.common.urlextension import method_splitter
from datawinners.entity.view.datasenders import all_datasenders_get, all_datasenders_post, disassociate_datasenders, all_datasenders_ajax, associate_datasenders
...
urlpatterns = patterns('',
                       ...
                       url(r'datasenders/$', method_splitter,
                                        {'GET': all_datasenders_get,
                                         'POST': all_datasenders_post
                                        },
                                        name='all_datasenders'),
                       (r'datasenders/ajax/$', all_datasenders_ajax),
