...
from mangrove.datastore.entity import get_by_short_code_include_voided, create_contact
...
def create_default_reporter(manager):
    try:
        ...
        pass
    entity = create_contact(dbm=manager, short_code=REPORTER_SHORT_CODE, location=DEFAULT_LOCATION)
