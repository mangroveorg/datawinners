...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('accountmanagement_datasenderprofile')

        # Adding field 'NGOUserProfile.reporter_id'
        db.add_column('accountmanagement_ngouserprofile', 'reporter_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'DataSenderProfile'
        db.create_table('accountmanagement_datasenderprofile', (
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.Organization'])),
            ('reporter_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('accountmanagement', ['DataSenderProfile'])

        # Deleting field 'NGOUserProfile.reporter_id'
        db.delete_column('accountmanagement_ngouserprofile', 'reporter_id')
