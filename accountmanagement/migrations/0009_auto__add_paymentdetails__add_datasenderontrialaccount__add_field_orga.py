...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accountmanagement_paymentdetails', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountmanagement.Organization'])),
            ('invoice_period', self.gf('django.db.models.fields.TextField')()),
            ('preferred_payment', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('accountmanagement', ['PaymentDetails'])

    def backwards(self, orm):
        
        # Deleting model 'PaymentDetails'
        db.delete_table('accountmanagement_paymentdetails')
