...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accountmanagement_organization', (
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('sector', self.gf('django.db.models.fields.TextField')()),
            ('address', self.gf('django.db.models.fields.TextField')()),
            ('addressline2', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('org_id', self.gf('django.db.models.fields.TextField')(primary_key=True)),
        ))
        db.send_create_signal('accountmanagement', ['Organization'])

        # Adding model 'NGOUserProfile'
        db.create_table('accountmanagement_ngouserprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('org_id', self.gf('django.db.models.fields.TextField')()),
            ('office_phone', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('mobile_phone', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('skype', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('accountmanagement', ['NGOUserProfile'])

        # Adding model 'SMSC'
        db.create_table('accountmanagement_smsc', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vumi_username', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('accountmanagement', ['SMSC'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accountmanagement_organization')

        # Deleting model 'NGOUserProfile'
        db.delete_table('accountmanagement_ngouserprofile')

        # Deleting model 'SMSC'
        db.delete_table('accountmanagement_smsc')
