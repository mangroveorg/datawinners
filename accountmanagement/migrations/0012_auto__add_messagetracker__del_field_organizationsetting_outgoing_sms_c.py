...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MessageTracker'
        db.create_table('accountmanagement_messagetracker', (
            ...
            ('incoming_sms_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('outgoing_sms_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('accountmanagement', ['MessageTracker'])

        # Deleting field 'OrganizationSetting.outgoing_sms_count'
        db.delete_column('accountmanagement_organizationsetting', 'outgoing_sms_count')

        # Deleting field 'OrganizationSetting.incoming_sms_count'
        db.delete_column('accountmanagement_organizationsetting', 'incoming_sms_count')


    def backwards(self, orm):
        
        # Deleting model 'MessageTracker'
        db.delete_table('accountmanagement_messagetracker')

        # Adding field 'OrganizationSetting.outgoing_sms_count'
        db.add_column('accountmanagement_organizationsetting', 'outgoing_sms_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'OrganizationSetting.incoming_sms_count'
        db.add_column('accountmanagement_organizationsetting', 'incoming_sms_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
