...
class ReporterRegistrationForm(Form):
    ...
    commune = CharField(max_length=30, required=False, label="Location(lowest administrative boundaries")
    geo_code = CharField(max_length=30, required=False, label="GPS Co-ordinates")
